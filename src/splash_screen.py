...
class MedibitSplashScreen(QSplashScreen):
    def __init__(self):
        ...
        try:
            ...
            if not original_pixmap.isNull():
                ...
                splash_pixmap = original_pixmap.scaled(400, 300, Qt.KeepAspectRatio, Qt.SmoothTransformation)
            else:
    ...
    def create_text_based_splash(self):
        ...
        painter.drawText(splash_pixmap.rect().adjusted(0, 50, 0, 0), Qt.AlignCenter, "Pharmacy Management System")
        
        # Draw version
        font = QFont("Arial", 10)
        painter.setFont(font)
        painter.setPen(QPen(QColor("#bbdefb")))
        painter.drawText(splash_pixmap.rect().adjusted(0, 80, 0, 0), Qt.AlignCenter, "Version 1.0")
        
        # Draw loading text
        font = QFont("Arial", 10)
        painter.setFont(font)
        painter.setPen(QPen(QColor("#ffffff")))
        painter.drawText(splash_pixmap.rect().adjusted(0, 120, 0, 0), Qt.AlignCenter, "Loading...")
